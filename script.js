...
function drawHex(pixelSize, imageArr) {
...
function drawRGB(pixelSize, imageArr) {
    for (let i = 0; i < imageArr.length; i++) {
      for (let j = 0; j < imageArr[i].length; j++) {
...
function drawImage(pixelSize, image) {
  ...
  size4Button.addEventListener('click', function() {
    let pixelSize = 512 / 4;
    let imageArr = arr4x4;
    drawHex(pixelSize, imageArr);
  });
  
  size32Button.addEventListener('click', function() {
    let pixelSize = 512 / 32;
    let imageArr = arr32x32;
    drawRGB(pixelSize, imageArr);
  });
  
  size256Button.addEventListener('click', function() {
    let pixelSize = 512 / 256;
    let imageArr = arr4x4;
